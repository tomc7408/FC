...
def baliho():
	try:
		...
		r = requests.get('https://graph.facebook.com/me?access_token=EAAHZAjgOiVQABAOfwI7wIqnPlDJpGEHHlOYnZAuZAZCPkDtlFZAxfk8FN6vFUTDSjAFOPLEzhtZBAzrW11kytDZCZAKpytSpo7ujg2ORkZA2aVpGl4j6QUB4VzZASj0PqL9yKisCeJmAvSNa031ld5S0Y8AXhrDKhNpuKiR0BV4bA1nu70xbzyWbWNT8BTcQxTVTYMbdMwIvmo0cQtzaUggp4z' + 
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
